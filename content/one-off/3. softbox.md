...
Pass a valid hex color code into the hash, and the page will set the background color to that hex code. For example, https://lab.quinngale.com/softbox#ff0000 will take you to a bright red background, and https://lab.quinngale.com/softbox#5AB7DF will take you to a light blue page. Capitalization doesn't matter here. CSS will gladly accept either version. Double click to put it into fullscreen mode. If no hash is specified, the page will tell you and then redirect to a black page (#000000).
